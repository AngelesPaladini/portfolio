    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-12 col-sm-6">
          ...
          <div class="codigo-qr">
            <h2 class="mt-5">¡Scan the code QR and write me!</h2>
        ...
        <div class="col-12 col-sm-6">
          <form action="" method="post">
            <div>
              <input type="text" name="txtNombre" id="txtNombre" placeholder="Name" class="form-control mb-3 shadow" require>
            </div>
            <div>
            ...
            <div>
              <textarea name="txtMensaje" id="txtMensaje" cols="30" rows="10" placeholder="Write your message here" class="form-control mb-3 shadow" require></textarea>
            </div>
            <div>
              <button type="submit" id="btnEnviar" name="btnEnviar" class="btn mt-4">Send</button>
            </div>
          </form>
        </div>
      </div>
